$(function ()
{
    ...
    $($(".ul1>li")[4]).click(function ()
    {
        ...
        var Tel=$('<input type="text" class="tel" style="width: 150px;margin-left: 10px;outline: none;" placeholder="请输入新的宿舍号">')
                            ...
                            $.ajax(
                                {
                                    ...
                                    success:function(data)
                                    {
                                        console.log(data);
                                        alert("宿舍号修改成功");
                                        javascrtpt:window.location.href='studentWelcome.html';
                                    }
                                    ,error:function ()
                                    {
                                        alert("修改失败请联系管理员");
...
$(function ()
{
    ...
    $($(".ul1>li")[5]).click(function ()
    {
        ...
        var div2= $("<div style='border: black 1px solid;border-radius: 5px 5px;width: 250px; height: 30px;margin-left: 220px;margin-bottom: 30px'>").text("姓名:")
        var div3= $("<div style='border: black 1px solid;border-radius: 5px 5px;width: 250px; height: 30px;margin-left: 220px; margin-bottom: 30px'>").text("密码:")
        var div4= $("<div style='border: black 1px solid;border-radius: 5px 5px;width: 250px; height: 30px;margin-left: 220px; margin-bottom: 30px'>").text("新老师工号:")
        div1.append(id);
        div2.append(UserName);
        div3.append(oldPwd);
        div4.append(Tel)
